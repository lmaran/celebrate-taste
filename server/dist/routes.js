...
module.exports = function(app) {
    ...
    app.post(
        "/api/myPreferences",
        auth.hasRole("user"),
        require("./api/preference/preferenceController").saveMyPreferences,
    );
    ...
    app.delete(
        "/api/myReviews/:dishId/:menuDate",
        auth.hasRole("user"),
        require("./api/review/reviewController").deleteMyReview,
    );
    ...
    app.get(
        "/api/customerEmployees/checkEmail/:email",
        require("./api/customerEmployee/customerEmployeeController").checkEmail,
    );
    ...
    app.use("/api/deliveryLogs", auth.hasRole("partner"), require("./api/deliveryLog/deliveryLogRoutes"));
    ...
    app.get("/changePassword", auth.isAuthenticated(), function(req, res) {
